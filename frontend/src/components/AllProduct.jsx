...
export default function ProductListing() {
    ...
    try {
      ...
      const sortedData = data
        ...
        .filter((product) => {
          ...
          console.log(`Checking product ${product.title || 'Unnamed'}: price=${price}, min=${minPrice}, max=${maxPrice}, withinRange=${withinPriceRange}`);
  ...
  const handleCategoryChange = (categoryId) => {
    ...
    // fetchProducts(); // Triggered via useEffect
  };
